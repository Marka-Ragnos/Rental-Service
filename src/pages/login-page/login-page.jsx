...
import withAuthorizationData from "../../hocs/with-authorization-data";
        ...
        <div className="page__login-container container">
          ...
          <section className="locations locations--login locations--current">
            <div className="locations__item">
              <Link
                to={`${Path.MAIN}`} className="locations__item-link">
...
export {LoginPage};
export default connect(mapStateToProps, mapDispatchToProps)(withAuthorizationData(LoginPage));
